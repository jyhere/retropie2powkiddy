...
# If you would like to create boxart image files from your collection, set this to True (otherwise, False)
# This assumes that the images were copied from those generated by Emulation Station and include a
# "-image" after the filename.
...
# If Games are found in the directory
if createDefaultImageFiles and gameListCount > 0:
...
# If Games should be renamed, create the subdirectory first
try:
